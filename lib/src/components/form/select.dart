...
enum SelectItemButtonDirection {
  left,
  right,
}
...
class SelectItemButton<T> extends StatelessWidget {
  final T value;
  final SelectItemButtonDirection direction;
  final Widget child;
  ...
  const SelectItemButton({
    super.key,
    required this.value,
    this.direction = SelectItemButtonDirection.right,
    required this.child,
  ...
  Widget build(BuildContext context) {
    ...
    return Button(
      ...
      leading: direction == SelectItemButtonDirection.left
          ? isSelected
              ? const Icon(
                  LucideIcons.check,
                ).iconSmall()
              : hasSelection
                  ...
                  : null
          : null,
      trailing: direction == SelectItemButtonDirection.right
          ? isSelected
              ? const Icon(
                  LucideIcons.check,
                ).iconSmall()
...
mixin SelectBase<T> {
  ...
  Function(bool open)? get onPopoverLisenter;
}
          ...
          child: Button(
            ...
            onPressed: widget.onChanged == null
                ...
                : () {
                    ...
                    widget.onPopoverLisenter?.call(true);
